    ...
    public static class OperatingSystem
    {
        ...
        public static string Name
        {
            get
            {
                switch (Id)
                {
                    case OperatingSystemId.BSD: return "BSD (bdsm lol)";
                    case OperatingSystemId.Linux: return "Linux (absolute chad)";
                    case OperatingSystemId.Darwin: return "macOS (slut)";
                    case OperatingSystemId.Windows: return "Windows (microfag)";
                    default: throw new PlatformNotSupportedException($"Unknown OS {Id} (what even the fuck are you using? templeos?)");
                }
            }
        }
